...
export default function Methodology() {
  const sections = [
    ['Step01 electricity', 'Annual electricity = rooms × 365 × electricity intensity, unless BMS/measured annual electricity is uploaded.'],
    ['Step01 cooling', 'Cooling electricity = annual electricity × cooling share. Cooling thermal = cooling electricity × existing electric chiller COP.'],
    ['Step01 heating', 'DHW heat = ORN × DHW L/ORN × 0.001163 × (Thot − Tcold) × (1 + losses). Laundry heat uses the workbook diesel heat coefficient.'],
    ['Step02 chiller sizing', 'Peak cooling kW is converted to RT and increased by a sizing margin. The model selects main and backup absorption chillers from candidate RT sizes.'],
    ['Step02 turbine sizing', 'Process steam demand = chiller steam duty + coincident heating duty. Turbine kW = steam flow × specific electric yield × utilization factor; the first suitable candidate turbine size is selected.'],
